...
{
    public class AgeRangerDataSQLite : IAgeRangerData
    {
        private string _connectionString = null;
        private IAgeRangerDataValidator _validator = null;


        internal AgeRangerDataSQLite(string ConnectionString, IAgeRangerDataValidator validator)
        {
...
//        public PersonItemModel GetPersonByID(int personId)
//        {
//            using (SQLiteConnection conn = new SQLiteConnection(_connectionString))
//            {
//                PersonItemModel temp = conn.Query<PersonItemModel>(@"
...
//join AgeGroup ag on (ag.MinAge is null or ag.MinAge <= p.Age) and (ag.MaxAge is null or ag.MaxAge > p.Age) 
//where p.Id = @Id;",
//                    new { id = personId }).FirstOrDefault();
